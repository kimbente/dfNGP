...
- [figues_real](figures_real)
    - Contains folders for each type of visualisation. Visualisations are saved as standardised tiles.
    - [visualise_real_tiles.ipynb](figures_real/visualise_real_tiles.ipynb) is a notebook that creates all visualisation tiles for the real data experiments, which are used for the figures in the paper.
- [figues_sim](figures_sim)
    ...
    - [visualise_sim_tiles.ipynb](figures_sim/visualise_sim_tiles.ipynb) is a notebook that creates all visualisation tiles for the simulated data experiments, which are used for the figures in the paper.
